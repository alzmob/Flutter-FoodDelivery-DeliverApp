            ...
            child: Center(child: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () => Get.toNamed(
                      RouteHelper.getOrderDetailsRoute(orderController.deliveredOrderList[index].id),
                      arguments: OrderDetailsScreen(
                        orderModel: orderController.deliveredOrderList[index], isRunningOrder: false, orderIndex: index,
                      ),
                    ),
                    child: Container(
                      padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
                      ...
                      child: Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Text(
                              orderController.deliveredOrderList[index].restaurantName,
                            ...
                            Row(children: [
                              ...
                              SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                              Text(
                                DateConverter.isoStringToLocalDateAnTime(orderController.deliveredOrderList[index].updatedAt),
