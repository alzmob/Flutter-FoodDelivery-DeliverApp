...
class OrderDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool _showSlider = (orderModel.paymentMethod == 'cash_on_delivery' && orderModel.orderStatus == 'accepted')
            ...
            Expanded(child: SingleChildScrollView(
              ...
              child: Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  (''  != null && ''.isNotEmpty) ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              action: () {
                if(orderModel.paymentMethod == 'cash_on_delivery' && orderModel.orderStatus == 'accepted') {
                  Get.dialog(ConfirmationDialog(
                    ...
                    onYesPressed: () {
                      orderController.updateOrderStatus(orderIndex, 'confirmed').then((success) {
                        Get.back();
                        if(success) {
                          Get.back();
