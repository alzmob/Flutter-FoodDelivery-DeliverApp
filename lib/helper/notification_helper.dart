...
class NotificationHelper {
  ...
  static Future<void> showBigTextNotification(Map<String, dynamic> message, FlutterLocalNotificationsPlugin fln) async {
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'big text channel id', 'big text channel name', 'big text channel description', importance: Importance.max, enableLights: true,
      styleInformation: bigTextStyleInformation, priority: Priority.max, sound: RawResourceAndroidNotificationSound('notification'),
    );
  ...
  static Future<void> showBigPictureNotificationHiddenLargeIcon(Map<String, dynamic> message, FlutterLocalNotificationsPlugin fln) async {
    ...
    final AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      ...
      largeIcon: FilePathAndroidBitmap(largeIconPath), priority: Priority.max, sound: RawResourceAndroidNotificationSound('notification'),
      styleInformation: bigPictureStyleInformation, importance: Importance.max, enableLights: true,
    );
